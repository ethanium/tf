    ...
    <tr>
      ...
      <td width="826" valign="top"><div align="justify" class="style14">
        <div align="left">
          <p class="style10">&nbsp;</p>
        <blockquote>
            <p class="style10"><font size=6>ADMINISTRATOR</p>
            <p class="style10"></font></p>
            
			<form name="form1" method="post" action="admin_pass.php">
			  <?php
			
				$Submit=$_POST[Submit];
				$radiobutton=$_POST[radiobutton];
				
				//echo"submit = $Submit <br> radiobutton : $radiobutton";
				if($Submit!="OK")
					{
					echo "Please select an item on the administrator menu submit: $Submit";
					}
					
				switch($radiobutton)
				{
					case('password'): 
						echo"<font size=5> PASSWORD  </font><br>";
						echo'<input name="rdpass" type=radio value=update> <font face="Palatino Linotype" size=4>Update Password <br>';
						echo'<input name="rdpass" type="radio" value="forgot"> Forgot Password? </font><br>';
						echo'<input name="OKpas" type="submit" value="OK">';
						 	switch($rdpass)
							{
								case 'update':
									echo"update";
						...
						break;
					case('database'):
						echo "<font size=5>DATABASE MAINTENANCE</font> <br>
								<TABLE>
								
								<TR>
			   					<TD>&nbsp;</TD>
							   	<TD><a href=\"add_rec.php\"><font face=\"Palatino Linotype\" size=4>Add Record</a>  <br> </TD>
								</TR>
								
								<TR>
			   					<TD>&nbsp;</TD>
							   	<TD><a href=\"update_rec.php\"><font face=\"Palatino Linotype\" size=4>Update Record</a>  <br> </TD>
								</TR>
								
								<TR>
			   					<TD>&nbsp;</TD>
							   	<TD><a href=\"view_rec.php\"><font face=\"Palatino Linotype\" size=4>View Record</a>  <br> </TD>
								</TR>
								
								<TR>
			   					<TD>&nbsp;</TD>
							   	<TD><a href=\"del_rec.php\"><font face=\"Palatino Linotype\" size=4>Delete Record</a>  <br> </TD>
								</TR>
						...
						break;
					case(''):
						echo "<font size=5>Please select an item on the administrator menu </font>";break;
				}
