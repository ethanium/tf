		...
		<form name="form2" method="post" action="fhistory_savestatus.php">  
          ...
          <TABLE>
            <TR>
              ...
              <TD valign=top>&nbsp;</TD>
              <TD valign=top>&nbsp;</TD>
              <TD valign=top><p><STRONG>Year:</STRONG></TD>
              <TD valign=top><select name="cbyear" id="cbyear">
            ...
            <TR>
              ...
              <TD>&nbsp;</TD>
              <TD>&nbsp;</TD>
              <TD><p><STRONG>City:</STRONG></TD>
              <TD><select name="cbcity" id="cbcity" >
                  <option value="\" selected>--Select--</option>
            ...
            <TR>
              ...
              <TD>&nbsp;</TD>
              <TD>&nbsp;</TD>
              <TD><p><STRONG>Month:</STRONG></TD>
              <p>
              <TD><select name="cbmonth" id="cbmonth">
                  <option value="\" selected>--Select--</option>
            ...
            <TR>
              ...
              <TD>&nbsp;</TD>
              <TD>&nbsp;</TD>
              <TD><p><STRONG>No. of tourist:</STRONG></TD>
              <p>
              <TD><input name="no_tourist" type="text" id="no_tourist">
      *in thousands </TD>
            </TR>
            <TR>
              <TD>&nbsp;</TD>
              ...
              <TD><select name="cbpurpose" id="cbpurpose">
                  <option value="\" selected>--Select--</option>
            ...
            <tr>
              ...
              <TD>&nbsp;</TD>
              <TD>&nbsp;</TD>
              <TD align="right"><input name="Save" type="submit" id="Save" value="REGISTER" align=RIGHT></TD>
          </TABLE>
          <p>&nbsp;</p>
        </form>      
      <p>&nbsp;</p>
