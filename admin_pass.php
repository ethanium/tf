				...
				switch($rdpass)
					{
						...
						case 'update':
								{echo "
								<form action=\"admin_pass_stat.php\" method=\"post\">
								
								<TABLE>
								<font face=\"Palatino Linotype\" size=4><BR>Update Password </font>
								...
								<TR>
			   					<TD>&nbsp;</TD>
							   	<TD>&nbsp;</TD>
								<TD align=\"right\">Back to Main</TD>
								</TR>
						...
						case 'forgot':
							{
							echo"
								<font face=\"Palatino Linotype\" size=4><BR>Forgot Password? <BR></font>
								<font size=4> Enter the Names of TF Creator :  </font>
								
								<form action=\"admin_forgot_stat.php\" method=\"post\">
								...
								<TR>
			   					<TD>&nbsp;</TD>
							   	<TD>&nbsp;</TD>
								<TD align=\"right\"><input name=\"OK\" type=\"submit\" value=\"OK\"></TD>
								</TR>
