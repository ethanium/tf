...
<div align="left">
  <table width="974" border="">
    <tr background ="winter.jpg">
      <td height="154" colspan="3"><object classid=clsid:D27CDB6E-AE6D-11cf-96B8-444553540000
...
scale= showall> </embed>
    ...
    <tr>
      ...
      <p class="style8">&nbsp;</p></td>
      <td width="619" valign="top"><div align="justify" class="style14">
        <div align="left">
          <p class="style10">&nbsp;</p>
          <blockquote>
            <p class="style10"><font size=5>ADMINISTRATOR MAIN MENU </p>
            ...
            <form name="form1" method="post" action="admin_menu.php">
			 ...
			 <TR>
			   ...
			   <TD width="20">&nbsp;</TD>
			   <TD width="322"><p>
			     <input name="radiobutton" type="radio" value="password">
		        PASSWORD</p></TD>
			  <TD width="9">&nbsp;</TD>
              <TD width="26">&nbsp;</TD>
			 ...
			 <TR>
			   ...
			   <TD>&nbsp;</TD>
			   <TD><p>
			     <input name="radiobutton" type="radio" value="database">
		        DATABASE MAINTENANCE </p></TD>
			  <TD>&nbsp;</TD>
              <TD>&nbsp;</TD>
