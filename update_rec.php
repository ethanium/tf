...
.style30 {color: #FFFFFF; font-family: "Palatino Linotype"; }
.style31 {font-size: x-small; font-family: "Palatino Linotype"; }
.style32 {font-weight: bold; color: #FFFFFF;}
-->
</style>
<div align="left">
...
scale= showall> </embed>
    ...
    <tr>
      <td width="132" height="399" valign="top"><p>&nbsp;</p>
        ...
        <p align="center" class="style31"><a href="forecast.php" class="style32"><font size=5>Forecaster</font></a></p>
          <p align="center" class="style31"><a href="help.php" class="style32"><font size=5>Help</font></font></a></p>
          <p align="center" class="style31"><a href="about.php" class="style32"><font size=5>About</font></a></p>
          <p class="style26">&nbsp;</p>
      ...
      <td width="826" valign="top"><div align="justify" class="style14">
        <div align="left">
          <p class="style10">&nbsp;</p>
          <blockquote>
            <p class="style10 style29"> <font size=5>TOURIST ARRIVAL RECORD:</p>
            <p class="style30">UPDATE RECORD: </font></p>
          </blockquote>
        <form name="form2" method="post" action="update_stat.php">  
          <TABLE>
		  	 <TR>
              <TD valign=top>&nbsp;</TD>
              <TD valign=top>&nbsp;</TD>
			...
			<tr>
              ...
              <TD>&nbsp;</TD>
              <TD align="right">
			   <input  name="REG" type="submit" class="style29" id="Save" value="OK" align=RIGHT>
			   <a href="admin_main.php">Back to Main</a>
			   </TD> 
			  <TD>
			  </TD>
			  <TD align="right">&nbsp;</TD>
